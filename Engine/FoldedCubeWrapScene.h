...
#include "Scene.h"
#include "CubeFoldedWrap.h"
#include "ScreenTransformer.h"
#include "Mat3.h"

class FoldedCubeWrapScene : public Scene
{
public:
	FoldedCubeWrapScene()
		:
		Scene("Folded Textured Wrapped Cube")
	{}
...
private:
	...
	CubeFoldedWrap cube = CubeFoldedWrap(1.0f);
	Surface sbTex = Surface::FromFile(L"Images\\sauron-100x100.png");
